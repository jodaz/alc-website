        ...
        <div class="row">
            <div class="col-12 col-md-8 col-article">
                <section>
                    <div class="row">
                        <div class="col-12">
                            <h2 class="container--title">{{ $title1 }}</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                            <h2 class="container--title">{{ $title2 }}</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <hr>
                            <p align = "justify">El municipio está ubicado en la costa centro-norte del estado Sucre, a 120 km. de Cumaná. La capital del municipio, Carúpano, es el principal centro urbano de la región de Paria, concentrando servicios administrativos, portuarios, educacionales, salud, sedes de comercializaciones de productos pesqueros, entre otros.</p>
