        ...
        <div class="row">
            <div class="col-12 col-md-8 col-article">
                ...
                <div class="row">
                    <div class="col-12">
                        <hr>
                        <p align= "justify">En el Municipio Bermúdez se elaboran exquisitos platos con especies marinas como lo es el popular sancocho de pescado especialidad culinaria de los carupaneros sin faltar la botella de ron, el siete potencias o rompe colchón, las famosas empanadas de cazón, no olvidando los famosos chorizos carupaneros y las morcillas, la jalea y el casabe macarapanero, el dulce de cereza, los turrones, dulce de jobo y las bolitas de coco.</p>

                        <img src="{{ asset('assets/staticpages/image1.png') }}" style="max-width: 100%; height: auto; margin-right:auto; margin-left: auto; display: block;"></img>
                        <br>

                        <div class="row">
                          <div class="column" style="float: left; width: 50%; padding: 5px;">
                            <img src="{{ asset('assets/staticpages/chorizo.png') }}" alt="Chorizo Carupanero" style="width:100%">
                          </div>
                          <div class="column" style="float: left; width: 50%; padding: 5px;">
                            <img src="{{ asset('assets/staticpages/empanada.jpeg') }}" alt="Empanadas" style="width:100%">
                          </div>
                        </div>
